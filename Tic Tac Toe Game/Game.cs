    ...
    public partial class Game : Form
    {
        public Game(bool isHost, string ip = null)
        {
            ...
            if(isHost)
            {
                PlayerChar = 'X';
                OpponentChar ='O';
                server = new TcpListener(IPAddress.Parse("192.168.0.100"), 8080);
                server.Start();
        ...
        private bool CheckState()
        {
            ...
            if(button1.Text == button2.Text && button2.Text == button3.Text && button3.Text == button4.Text && button4.Text == button5.Text && button5.Text != "")
            {
                ...
                {
                    label1.Text = "Congratulations you win the game! ";
                    MessageBox.Show("Congratulations you win the game! ");
                }
                else
                {
                    label1.Text = "Sorry You Lost the game!";
            ...
            {
                label1.Text = "It's a draw! between you and yours opponent.";
                MessageBox.Show("It's a draw! between you and yours opponent.");
                return true;
            }
            return false;
        }
